function data2ppt_SHORT(xlsLayout2,outputLocation3,scatterDecision)
  ...
  %% Main Program
    for t = 1 : length(xlsLayout2)
        ...
        for i = 1 : size(Experiments,1) - 1
            ...
            toPowerPoint(folder_path,EXPname,EXPSUBname,curExp(3:end),PPTpath,scatterDecision(t),EXPData{t},verStr);
