            ...
            if ND== 2 % Number of dimentions 
                ...
                if intensityDescision(t) == 0
                    parTimeDependent = {'Velocity','Velocity_X','Velocity_Y','Acceleration','Acceleration_X','Acceleration_Y','Displacement2','MSD','Instantaneous_Angle'...
                        ...
                        ,'Coll','Eccentricity','Track_Displacement_X','Track_Displacement_Y','Ellip_Ax_B_X','Ellip_Ax_B_Y','Ellip_Ax_C_X','Ellip_Ax_C_Y','Instantaneous_Speed'};
                else
                    parTimeDependent = {'Velocity','Velocity_X','Velocity_Y','Acceleration','Acceleration_X','Acceleration_Y','Displacement2','MSD','Instantaneous_Angle'...
                        'Directional_Change','Area','Ellipticity_oblate','Ellipticity_prolate',...
                        'Sphericity','EllipsoidAxisLengthA','EllipsoidAxisLengthB','EllipsoidAxisLengthC'...
                        ,'Coll','Eccentricity','IntensityCenterCh1','IntensityCenterCh2','IntensityMaxCh1','IntensityMaxCh2',...
                        'IntensityMeanCh1','IntensityMeanCh2','IntensityMedianCh1','IntensityMedianCh2','IntensitySumCh1','IntensitySumCh2','Track_Displacement_X','Track_Displacement_Y'...
                ...
                if intensityDescision(t) == 0
                    parTimeDependent = {'Velocity','Velocity_X','Velocity_Y','Velocity_Z','Acceleration','Acceleration_X','Acceleration_Y','Acceleration_Z','Displacement2','MSD','Instantaneous_Angle'...
                        'Directional_Change','Area','Ellipticity_oblate','Ellipticity_prolate',...
                        'Sphericity','EllipsoidAxisLengthA','EllipsoidAxisLengthB','EllipsoidAxisLengthC'...
                        ,'Coll','Eccentricity','Track_Displacement','Track_Displacement_X','Track_Displacement_Y','Track_Displacement_Z','Volume','Ellip_Ax_A_X','Ellip_Ax_A_Y','Ellip_Ax_A_Z','Ellip_Ax_B_X','Ellip_Ax_B_Y','Ellip_Ax_B_Z','Ellip_Ax_C_X','Ellip_Ax_C_Y','Ellip_Ax_C_Z','Instantaneous_Speed'};
                else
                    parTimeDependent = {'Velocity','Velocity_X','Velocity_Y','Velocity_Z','Displacement2','Acceleration','Acceleration_X','Acceleration_Y','Acceleration_Z','MSD','Instantaneous_Angle'...
                        ...
                        'Sphericity','EllipsoidAxisLengthA','EllipsoidAxisLengthB','EllipsoidAxisLengthC'...
                        ,'Coll','Eccentricity','IntensityCenterCh1','IntensityCenterCh2','IntensityMaxCh1','IntensityMaxCh2',...
                        'IntensityMeanCh1','IntensityMeanCh2','IntensityMedianCh1','IntensityMedianCh2','IntensitySumCh1','IntensitySumCh2','Track_Displacement_X','Track_Displacement',...
                        'Track_Displacement_Y','Track_Displacement_Z','Volume'...
                ...
                if intensityDescision(t) == 0
                    parBarGraph = {'Velocity','Displacement2','MSD','Area','Linearity_of_Forward_Progression','Mean_Straight_Line_Speed','Mean_Curvilinear_Speed',...
                        ...
                        ,'Ellip_Ax_B_X','Ellip_Ax_B_Y','Ellip_Ax_C_X','Ellip_Ax_C_Y','Instantaneous_Speed','Track_Displacement','Track_Displacement_X','Track_Displacement_Y','Track_Displacement_Z'};
                else
