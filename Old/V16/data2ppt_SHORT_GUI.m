...
data2ppt_SHORT(handles.FullLayName,handles.datadirs,cell2mat(handles.ss),cell2mat(handles.IntensityAnalysis),cell2mat(handles.Concatanate),cell2mat(handles.ND),cell2mat(handles.normalize));
