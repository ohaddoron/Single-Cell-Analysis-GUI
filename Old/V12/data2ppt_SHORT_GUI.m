...
% Last Modified by GUIDE v2.5 29-Feb-2016 10:37:10
...
if ~isfield(handles,'choice')
    data2ppt_SHORT(handles.lay,handles.outdir,0,handles.intensityAnalysis,handles.Concatante,handles.ND,handles.normalize);
else
    data2ppt_SHORT(handles.lay,handles.outdir,handles.choice,handles.intensityAnalysis,handles.Concatante,handles.ND,handles.normalize);
end
