function handler = MC_Sun_plot_for_multiple_XZ( folder_path )
    ...
    mkdir(folder_path,'SunPlotXZ\Images');
    ...
    for i=1:num_of_graphs
        ...
        for j=1:min_cell_count
            ...
            cur_plot_handler = plot(x,z,'Color',cmap(j,:));
        end;
        ...
        hold off;        
        saveas(handler(i) ,[folder_path '\SunPlotXZ\Images\' cur_graph_name],'tif');
        saveas(handler(i) ,[folder_path '\SunPlotXZ\' cur_graph_name]);
        close all;
