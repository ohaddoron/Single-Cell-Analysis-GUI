...
if ~isfield(handles.Arrange,'choice')
    ...
    if ~isfield(handles,'pars')
        bar_graph(handles.foldername{1}{1},{'Velocity'},handles.Arrange,1,handles.Normalize,handles.direction);
    else
       bar_graph(handles.foldername{1}{1},handles.pars,handles.Arrange,1,handles.Normalize,handles.direction);
    end
else
    if ~isfield(handles,'pars')
        bar_graph(handles.foldername{1},{'Velocity'},handles.Arrange,1,handles.Normalize,handles.direction);
    else
        bar_graph(handles.foldername{1},handles.pars,handles.Arrange,1,handles.Normalize,handles.direction);
    end
end
