function Velocity_XVsVelocity_YVsTime(folderPath,concat)
    ...
    for i = 1 : len
        ...
        axis([-Ax Ax -Ax Ax]);
        saveas(handler(i),[folderPath '\Velocity_X VsVelocity_Y Vs Time\Sun\' graphs_data.title{i}]);
        saveas(handler(i),[folderPath '\Velocity_X VsVelocity_Y Vs Time\Images\Sun\' graphs_data.title{i} '.tiff']);
        ...
        maxax = max([ax.XLim,ax.YLim]);
        axis([0 Ax 0 Ax]);
        saveas(handler(i),[folderPath '\Velocity_X VsVelocity_Y Vs Time\Abs\' graphs_data.title{i}]);
        saveas(handler(i),[folderPath '\Velocity_X VsVelocity_Y Vs Time\Images\Abs\' graphs_data.title{i} '.tiff']);
        close all;
        ...
        maxax = max([ax.XLim,ax.YLim]);
        axis([0 Ax/5 0 Ax/5]);
        saveas(handler(i),[folderPath '\Velocity_X VsVelocity_Y Vs Time\Time\' graphs_data.title{i}]);
        saveas(handler(i),[folderPath '\Velocity_X VsVelocity_Y Vs Time\Images\Time\' graphs_data.title{i} '.tiff']);
    ...
    saveas(h,[folderPath '\Velocity_X VsVelocity_Y Vs Time\Avg\Vx vs Vy']);
    saveas(h,[folderPath '\Velocity_X VsVelocity_Y Vs Time\Images\Avg\Vx vs Vy.tiff']);
