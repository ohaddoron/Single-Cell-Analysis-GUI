...
% Last Modified by GUIDE v2.5 28-Mar-2016 10:53:07
...
%}
data2ppt_SHORT(handles.FileLayName,handles.datadirs,sslist,handles.IntensityAnalysis,handles.Concatanate,handles.ND,handles.normalize);
...
handles.datadirs{1} = uigetdir2('\\metlab21\Matlab','Select output location for the data');
for i = 1:handles.loop-1
    handles.datadirs{i+1} = uigetdir2('\\metlab21\Matlab','Select output directory for the data');
end
for i = 1:handles.loop
