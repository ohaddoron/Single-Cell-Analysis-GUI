...
[handles.FileLayName{1},handles.PathLayName{1}] = uigetfile('*.*','Choose file to load :','\\metlab22\G\RawGigaData\GigaDataLayout\Software\ImarisMatlabSPSS\ExperimentTemplets\Excel Templates');
for i = 2:handles.loop
