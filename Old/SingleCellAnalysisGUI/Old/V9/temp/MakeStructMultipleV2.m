function MakeStructMultipleV2(folderPath,outputLocation,dt)
%%  
    dt = dt/60;
...
%%
    ...
    for i = 1 : numOfSheets
        ...
        switch sheet
            ...
            case 'Ellipsoid Axis A'
                ...
                At.EllipAxA_A_Z = nan(nanmax(timeVal),nanmax(parentVal));
    ...
    At.Linearity_of_Forward_Progression(~isfinite(At.Linearity_of_Forward_Progression)) = [];
    %% Confinement ratio
