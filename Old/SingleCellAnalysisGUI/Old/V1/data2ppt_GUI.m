...
% Last Modified by GUIDE v2.5 01-Oct-2015 11:43:15
...
%}
data2ppt(handles.imarisdirs,handles.FullRename,handles.FullLayName,handles.outRename,handles.matdirs,handles.datadirs,cell2mat(handles.int),cell2mat(handles.ss));
...
%}
set(hObject,'String',handles.datadirs');
%{
contents = cellstr(get(hObject,'String'));
handles.Arrange.pick = cellstr(contents(get(hObject,'Value')));
%}
...
%}
set(hObject,'String',handles.matdirs');
%{
contents = cellstr(get(hObject,'String'));
handles.Arrange.pick = cellstr(contents(get(hObject,'Value')));
%}
...
%}
set(hObject,'String',handles.outRename');
guidata(hObject,handles);
...
set(hObject,'String',handles.int');
guidata(hObject,handles);
