...
% Last Modified by GUIDE v2.5 24-Nov-2015 09:15:20
...
handles.folders = [];
i = 1;
prompt = 'Do you want more folders?';
title = 'Select input folders:';
answer = inputdlg(prompt,title);
word = answer{1};
TF = strcmp(word,'no');
while TF == 0
    handles.inputfolder = uigetdir2;
    handles.folders{i} = handles.inputfolder;
    prompt = 'Do you want more folders?';
    title = 'Select input folders:';
    answer = inputdlg(prompt,title);
    word = answer{1};
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.outputfolder = uigetdir2('C:\Users\user\Documents\MATLAB\Yoav\045','');
guidata(hObject,handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
summaryTable(handles.folders,handles.pars,handles.outputfolder,handles.TP);
...
handles.TP.min = str2double(get(hObject,'String'));
guidata(hObject,handles);
...
handles.TP.max = str2double(get(hObject,'String'));
guidata(hObject,handles);
