...
% Last Modified by GUIDE v2.5 07-Dec-2015 15:24:05
...
if ~isfield(handles,'choice')
    data2ppt_SHORT(handles.lay,handles.outdir,0,handles.intensityAnalysis,handles.Concatante,handles.ND);
else
    data2ppt_SHORT(handles.lay,handles.outdir,handles.choice,handles.intensityAnalysis,handles.Concatante,handles.ND);
end
