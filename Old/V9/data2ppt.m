function data2ppt(varargin)
    ...
    for t = 1 : length(xlsLayout2)
        ...
        raw(3,find(Idx)) = {'NNN0'};
        PPTmasterspath = raw(Rup:Rdown-2,find(~cellfun(@isempty,strfind(raw(3,:),'Template'))));
        ...
        for i = 1 : size(Experiments,1)-1
            ...
            if ND(t) ~= 3 % Number of dimentions 
                %% 2D
                ...
                if intensityDescision(t) == 0
                    ...
                    parMaps = {'Velocity','Velocity_X','Velocity_Y','Coll','Acceleration','Acceleration_X','Acceleration_Y','IntensityCenterCh1','IntensityCenterCh2','IntensityMaxCh1','IntensityMaxCh2',...
                ...
                if intensityDescision(t) == 0
                    ...
                    parBarGraph = {'Velocity','Displacement2','MSD','Area','Linearity_of_Forward_Progression','Mean_Straight_Line_Speed','Mean_Curvilinear_Speed',...
                        'Confinement_Ratio','Track_Displacement_Length','Velocity_X','Velocity_Y','Velocity_Z','Coll','Directional_Change','EllipsoidAxisLengthA','EllipsoidAxisLengthB','EllipsoidAxisLengthC',...
                        'IntensityCenterCh1','IntensityCenterCh2','IntensityMaxCh1','IntensityMaxCh2',...
                        'IntensityMeanCh1','IntensityMeanCh2','IntensityMedianCh1','IntensityMedianCh2','IntensitySumCh1','IntensitySumCh2'...
                        ,'Ellip_Ax_A_X','Ellip_Ax_A_Y','Ellip_Ax_A_Z','Ellip_Ax_B_X','Ellip_Ax_B_Y','Ellip_Ax_B_Z','Ellip_Ax_C_X','Ellip_Ax_C_Y','Ellip_Ax_C_Z','Instantaneous_Speed','Track_Displacement_X','Track_Displacement_Y','Track_Displacement_Z'...
                        'Acceleration','Acceleration_X','Acceleration_Y','Acceleration_Z','Ellipticity_oblate','Ellipticity_prolate','Volume','Eccentricity','Sphericity','Instantaneous_Angle'...
                        'Starting_Time','Starting_Value','Ending_Time','Ending_Value','Maximum_Height','Time_of_Maximum_Height','Full_Width_Half_Maximum'};
                end
                ...
                if scatterDecision(t) == 0
                    try
                        ...
                        Vx_vs_Vy_vs_Time_Layers ( folderPath , numOfLayers, layerWidth );
                    catch
                        scatterDecision(t) = 1;
                    end
                end
                ...
                if intensityDescision(t) == 0
                    parSummaryTable = {'Area','Acceleration','Coll','Confinement_Ratio','Directional_Change','Displacement','Displacement2','Ellip_Ax_A_X','Ellip_Ax_A_Y','Ellip_Ax_A_Z'...
                        ...
                        'Acceleration_X','Acceleration_Y','Acceleration_Z','Velocity_Z','Ellip_Ax_B_Z','Eccentricity','Ellip_Ax_A_X','Ellip_Ax_A_Y','Ellip_Ax_A_Z','Ellip_Ax_B_Z','Ellip_Ax_C_Z',...
                        'Ellip_Ax_B_Z'};
                else
                    parSummaryTable = {'Area','Acceleration','Coll','Confinement_Ratio','Directional_Change','Displacement','Displacement2','Ellip_Ax_A_X','Ellip_Ax_A_Y','Ellip_Ax_A_Z'...
                        'Ellip_Ax_B_X','Ellip_Ax_B_Y','Ellip_Ax_B_Z','Ellip_Ax_C_X','Ellip_Ax_C_Y','Ellip_Ax_C_Z',...
                ...
                %{
                if nargin >= 12 && par1vspar2 ~= 0
                    normalized_graphs (folder_path,{'Area','Velocity','MSD','Coll','Sphericity'},0,0);

                    A.choice = 1;

                    %bar_graph...
                    %        (folder_path,par,A,0,1,0); 
                    par1 = {'Area','Velocity'};
                    par2 = {'Velocity','MSD','Coll','Sphericity'};
                    par1_vs_par2 ([folder_path '\Normalized\' ], par1 , par2);
                end
                %}
