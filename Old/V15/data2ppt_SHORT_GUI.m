...
data2ppt_SHORT(handles.FullLayName,handles.datadirs,cell2mat(handles.sslist.String),cell2mat(handles.IntensityAnalysis),cell2mat(handles.Concatanate),cell2mat(handles.ND),cell2mat(handles.normalize));
...
% handles.FileLayName = [handles.PathLayName handles.FileLayName];
for i = 1 : handles.loop
    handles.FullLayName(i) = fullfile(handles.PathLayName(i),handles.FileLayName(i));
end;
rmpath(genpath(pwd));
guidata(hObject,handles);
