...
% Last Modified by GUIDE v2.5 16-Nov-2015 14:38:04
...
%}
data2ppt(handles.imarisdirs,handles.FullRename,handles.FullLayName,handles.outRename,handles.matdirs,handles.datadirs,cell2mat(handles.int),cell2mat(handles.ss),cell2mat(handles.IntensityAnalysis));
