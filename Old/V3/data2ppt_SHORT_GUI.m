...
% Last Modified by GUIDE v2.5 16-Nov-2015 15:35:20
...
if ~isfield(handles,'choice')
    data2ppt_SHORT(handles.lay,handles.outdir,0,handles.intensityAnalysis);
else
    data2ppt_SHORT(handles.lay,handles.outdir,handles.choice,handles.intensityAnalysis);
end
