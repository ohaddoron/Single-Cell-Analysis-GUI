function varargout = par1_vs_par2_GUI(varargin)
% PAR1_VS_PAR2_GUI MATLAB code for par1_vs_par2_GUI.fig
%      PAR1_VS_PAR2_GUI, by itself, creates a new PAR1_VS_PAR2_GUI or raises the existing
%      singleton*.
%
%      H = PAR1_VS_PAR2_GUI returns the handle to a new PAR1_VS_PAR2_GUI or the handle to
%      the existing singleton*.
%
%      PAR1_VS_PAR2_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PAR1_VS_PAR2_GUI.M with the given input arguments.
%
%      PAR1_VS_PAR2_GUI('Property','Value',...) creates a new PAR1_VS_PAR2_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before par1_vs_par2_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to par1_vs_par2_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help par1_vs_par2_GUI

% Last Modified by GUIDE v2.5 06-Jun-2016 09:08:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @par1_vs_par2_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @par1_vs_par2_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before par1_vs_par2_GUI is made visible.
function par1_vs_par2_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to par1_vs_par2_GUI (see VARARGIN)

% Choose default command line output for par1_vs_par2_GUI
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes par1_vs_par2_GUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = par1_vs_par2_GUI_OutputFcn(hObject, eventdata, handles) 
...
par1_vs_par2 (handles.folderPath{1} , handles.par1Chosen , handles.par2Chosen,handles.normalize)
